...
ARG PROJECT_PACKAGES_PLUS=config,shiny,shinycssloaders,shinyjs,shinyWidgets,stringr,scales,waiter,dplyr,readxl,data.table,geojsonio,sf,RMySQL,DBI,pool,mongolite,here,ggplot2,ggiraph,ggiraphExtra,RColorBrewer,viridis,hrbrthemes,lattice,leaflet
ARG DEPENDENCY=ALL
...
RUN ${LIB_DIR}/cont-init.d-defaults/04_install_packages.sh
