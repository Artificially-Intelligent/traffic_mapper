...
bike_traffic <- get_traffic(group_by = c('location', "direction")) %>% as.data.frame()

ggPieDonut(bike_traffic,aes(pies="direction",donuts="location",count="count"),interactive=TRUE)
